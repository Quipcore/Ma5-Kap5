...
namespace Matematik5_Kapitel5_Uppgift31
  ...
  */
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (Rep)
            {
                Console.WriteLine("1. Mersennes Talföljden (Utan Lucas-Lehmer metoden) (Tar 10^60 gånger Universums ålder att genomföra!)");
